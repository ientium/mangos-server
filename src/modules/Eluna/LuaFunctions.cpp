...
ElunaRegister<Player> PlayerMethods[] =
{
	...
	//VIPInfo 信息相关
	{ "getVipCoin", &LuaPlayer::getVipCoin },
	{ "getVipFlyingTime", &LuaPlayer::getVipFlyingTime },
	{ "getVipTimeToCoin", &LuaPlayer::getVipTimeToCoin },  //获取VIP未转化时间
	{ "setUpdateFlyingTime", &LuaPlayer::setUpdateFlyingTime },  //获取VIP未转化时间
	{ "setVipCoin", &LuaPlayer::setVipCoin },  //获取VIP未转化时间
	{ "GetLevel", &LuaPlayer::GetLevel },  //获取用户等级
	{ "SetLevelUp", &LuaPlayer::SetLevelUp },  //提升等级
	{ "GetMaxLevel", &LuaPlayer::getMaxLevel },  //获取服务器最大等级
	{ "IsFlying", &LuaPlayer::IsFlying },                                // :IsFlying() - UNDOCUMENTED
